...
EXP_ROOT="./veri_776_two_losses_sa"

python two_losses_train.py \
    --train_set $ANNO_ROOT \
    --model_name mobilenet_v1_1_224_w_sa \
    ...
    --head_name fc1024_two_heads \
    --lmcl_learning_rate 0.02 \
    --lmcl_alpha 0.40 \
    --lmcl_scale 64 \
    --lmcl_dis_th 0.88 \
    --triplet_margin soft \
    --triplet_metric euclidean \
    --triplet_loss batch_hard \
    --triplet_learning_rate 3e-4 \
